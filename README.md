...
| kubenode (B) | 2×Intel Xeon Silver 4314 / 16×32GB DDR5 / 2×Samsung 4TB NVMe / 2×25GbE | 32 | 8 | 13 200 | 260 |
| lvs-l4 | 1×Intel Xeon E‑2334 / 4×8GB / 1×NVMe 512GB / 2×100GbE | 8 | 14 | 4 800 | 73 (аналог Hetzner EX101) |
| nginx-l7 (A) | 2×Intel Xeon Silver 4314 / 4×16GB / 2×NVMe 512GB / 2×100GbE | 16 | 15 | 6 200 | 106 |
| nginx-l7 (B) | 2×Intel Xeon Silver 4314 / 4×16GB / 2×NVMe 512GB / 2×100GbE | 16 | 6 | 6 200 | 106 |
| db-postgres | 2×AMD EPYC 7282 / 8×32GB / 4×NVMe 4TB / 2×25GbE | 32 | 32 | 16 500 | 275 |
| db-scylla | 2×AMD EPYC 7282 / 8×32GB / 8×NVMe 8TB / 2×25GbE | 32 | 21 | 24 000 | 400 |
| db-redis | 2×Intel Xeon Silver 4210R / 16×32GB / 2×NVMe 512GB / 2×25GbE | 20 | 42 | 13 500 | 225 |
| kafka | 2×Intel Xeon Silver 4210 / 4×32GB / 4×NVMe 4TB / 2×25GbE | 16 | 21 | 9 100 | 152 |
| ceph-mon | 1×Intel Xeon E‑2334 / 2×16GB / 2×NVMe 512GB / 2×10GbE | 8 | 9 | 4 800 | 73 |
| ceph-rgw | 2×AMD EPYC 7282 / 4×32GB / 2×NVMe 2TB / 2×100GbE | 32 | 9 | 11 200 | 188 |
| ceph-osd | 1×Intel Xeon E‑2334 / 4×16GB / 12×HDD 18TB / 2×25GbE | 8 | 55* | 20 500 | 340 |
...
Стоимость покупки включает barebone, процессоры, память и диски (по розничным ценам Newegg/CDW, 2025). Стоимость аренды базируется на ближайших аналогах Hetzner (серия AX, EX, SX). Для kubenode (A) использован Hetzner AX162‑S с апгрейдом до 512 ГБ RAM и 2×4 ТБ NVMe. Для OSD-узлов — Hetzner SX133 (цена скорректирована с учётом 12×18 ТБ HDD).
...
## 11.6 Сравнение стоимости покупки и аренды (итоговая рекомендация)

| Компонент | Решение | Обоснование |
|-----------|---------|-------------|
| GPU‑кластер (H100) | Покупать | Экономия $800 000/год на кластере из 10 серверов по сравнению с арендой у hyperscaler. |
| Kubernetes‑узлы (kubenode) | Покупать | При масштабе >10 шт. выгоднее на $19 440/год. Полный контроль над оборудованием. |
| LVS, Nginx | Покупать | Быстро окупаются за 2–3 года. |
| PostgreSQL, ScyllaDB, Redis, Kafka | Покупать | Высокая утилизация, длительный срок службы. |
| Ceph OSD (холодное хранение) | Арендовать | Частая замена дисков (каждые 3–5 лет), аренда снижает операционные риски. |
| Ceph RGW, MON | Покупать | Стабильная нагрузка, минимальное обслуживание. |

Таким образом, основной вычислительный парк и GPU выгоднее приобрести в собственность, а массивное файловое хранилище на HDD — арендовать, что формирует оптимальную по совокупной стоимости владения гибридную модель.
