...
Вот раздел **7. Алгоритмы**, оформленный в том же стиле, что и вся ваша работа. Он полностью соответствует обновлённой архитектуре (отсутствие `user_inbox` и `ws_mapping`, использование SSE, асинхронное обновление `chats`).
...
| Python (FastAPI / Ray) | Model Serving Wrapper и оркестратор| Стандарт дв ML-инженерии. Позволяет использовать нативные биндинги для PyTorch без накладных расходов на сериализацию в другие языки. |
