...
<img width="1308" height="877" alt="image" src="https://github.com/user-attachments/assets/b2da56c9-e409-45d8-9f35-1235a1f28735" />

Локации выбраны с учётом географии пользователей (см. 1 пункт работы)

| ID | Локация | Обслуживаемый регион | 
|----|---------|----------------------|
| DC1, DC5 | Майами (США) | Северная и Южная Америка | 
| DC2, DC6 | Амстердам (Нидерланды) | Европа, Африка, Ближний Восток | 
| DC3, DC7 | Сингапур (Сингапур) | Индия, Азия и Океания | 
| DC4 | Токио (Япония) | Япония, Корея, Северная Азия | 
...
| Азия (DC3, DC7) | 25 % | 2 934 | DC3: 1 467, DC5: 1 467 (50/50)   |
| Япония/Корея (DC6) | 15 % | 1 760 | DC5: 1 760 |
...
|-------|----------------------------------|-------------------|
| `api.gemini.google.com` | Основные API‑запросы | IP ближайшего ДЦ (Америка → DC1/DC5; Европа/Африка → DC2/DC6; Азия → DC3/DC7; Япония/Корея → DC4) |
...
| Механизм | Описание |
|----------|----------|
| Weighted Round‑Robin (DNS) | Для DC1, DC5 и DC2, DC6 и DC3, DC7 - т.е. внутри регионов. В Geo‑DNS задаются веса, пропорциональные ёмкости ДЦ. При плановых работах вес снижается, трафик перераспределяется. |
